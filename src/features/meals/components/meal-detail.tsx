            ...
            <section className="pt-4 pb-12" id="video">
              ...
              <div className="aspect-video w-full overflow-hidden rounded-3xl border border-slate-100 bg-slate-50 shadow-md">
                <iframe
                  ...
                  loading="lazy"
                  src={embedUrl}
                  srcDoc={`<style>*{padding:0;margin:0;overflow:hidden}html,body{height:100%}img,span{position:absolute;width:100%;top:0;bottom:0;margin:auto;object-fit:cover}span{height:1.5em;text-align:center;font:48px/1.5 sans-serif;color:white;text-shadow:0 0 0.5em black;transition:transform 0.2s}a:hover span{transform:scale(1.1)}</style><a href="${embedUrl}"><img id="thumb" src="https://images.weserv.nl/?url=https://i.ytimg.com/vi_webp/${youtubeId}/maxresdefault.webp" alt="${meal.strMeal}"><span>▶</span></a><script>const thumb=document.getElementById("thumb");const fallbacks=["https://images.weserv.nl/?url=https://i.ytimg.com/vi_webp/${youtubeId}/sddefault.webp","https://images.weserv.nl/?url=https://i.ytimg.com/vi_webp/${youtubeId}/hqdefault.webp","https://images.weserv.nl/?url=https://i.ytimg.com/vi_webp/${youtubeId}/mqdefault.webp","${meal.strMealThumb}"];let i=0;thumb.onerror=function(){if(i<fallbacks.length){thumb.src=fallbacks[i++]}else{thumb.onerror=null}};</script>`}
